...
public class MangaSyncService : IMangaSyncService
{
    ...
    // Matches slugs generated by newSlug() in AdminScrambleTab.tsx (`chapter-` + 12
    // lowercase hex chars). Used to detect a checkpoint-upload race: the Drive folder
    // exists but manifest.json hasn't been PATCHed with its entry yet.
